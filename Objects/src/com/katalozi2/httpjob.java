...
public class httpjob extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.katalozi2.httpjob");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.katalozi2.httpjob.class).invoke(this, new Object[] {null});
        else
...
public String  _vv4(int _id) throws Exception{
...
__c.CallSubDelayed2(ba,(Object)(_vvvvvvv1.getObject()),"SubmitJob",this);
...
_b = __c.LoadBitmap(_vvvvvvv1._v0 /*String*/ ,_vvvvvv2);
...
if (true) return __c.LoadBitmapResize(_vvvvvvv1._v0 /*String*/ ,_vvvvvv2,_width,_height,_keepaspectratio);
...
if (true) return __c.LoadBitmapSample(_vvvvvvv1._v0 /*String*/ ,_vvvvvv2,_width,_height);
...
_in = __c.File.OpenInput(_vvvvvvv1._v0 /*String*/ ,_vvvvvv2);
...
_tr.Initialize2((java.io.InputStream)(__c.File.OpenInput(_vvvvvvv1._v0 /*String*/ ,_vvvvvv2).getObject()),_encoding);
...
__c.LogImpl("94390919","Cannot send files from the assets folder.",0);
...
String _value = "";
String _s = "";
com.katalozi2.httpjob._multipartfiledata _fd = null;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_fd = (com.katalozi2.httpjob._multipartfiledata)(group17.Get(index17));
...
__c.File.Delete(_vvvvvvv1._v0 /*String*/ ,_vvvvvv2);
